...
namespace WebApi.Interfaces
{
    public interface IMaintenanceRepository
    {
        ...
        Task<MaintenanceContractorLine[]> GetAllMaintenanceContractorLineAsync(int MaintenanceID);
        Task<MaintenanceContractorLine> GetMaintenanceContractorLineByID(int MaintenanceID, int contractorId);
        Task<MaintenanceContractorLine> DeleteAllMaintenanceContractorLineAsync(MaintenanceContractorLine[] item);
