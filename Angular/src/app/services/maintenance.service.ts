...
export class MaintenanceService { // Rename the service class
  ...
  getPayment(paymentID: number) { // Rename the method
    return this._httpClient
      .get(
        `https://localhost:7251/api/Maintenance/GetPayment/${paymentID}`, // Update the API URL
      )
      .pipe(map((result) => result));
  }
  ...
  EditPayment(x:any,maintenance: Payment) { 
    return this._httpClient
      .put(`https://localhost:7251/api/Maintenance/EditPayment?id=${x}`, maintenance) // Update the API URL
      .pipe(map((result) => result));
  }
  ...
  getMaintenanceType(maintenanceTypeID: number) { // Rename the method
    return this._httpClient
      .get(
        `https://localhost:7251/api/Maintenance/GetMaintenanceType/${maintenanceTypeID}`, // Update the API URL
      )
      .pipe(map((result) => result));
  }
  EditMaintenancetype(x:any,maintenance: MaintenanceType) { 
    return this._httpClient
      .put(`https://localhost:7251/api/Maintenance/EditMaintenanceType?id=${x}`, maintenance) // Update the API URL
      .pipe(map((result) => result));
  }
  deleteMaintenanceType(maintenanceTypeID: number) { // Rename the method
    return this._httpClient
      .delete(`https://localhost:7251/api/Maintenance/DeleteMaintenanceType?MaintenanceTypeId=${maintenanceTypeID}`) // Update the API URL
      .pipe(map((result) => result));
  }
  ...
  getMaintenanceStatus(maintenanceTypeID: number) { // Rename the method
    return this._httpClient
      .get(
  ...
  EditMaintenanceStatus(x:any,maintenance: MaintenanceStatus) { 
    return this._httpClient
      .put(`https://localhost:7251/api/Maintenance/EditMaintenanceStatus?id=${x}`, maintenance) // Update the API URL
      .pipe(map((result) => result));
  }
  ...
  getMaintenanceNote(maintenanceTypeID: number) { // Rename the method
    return this._httpClient
      .get(
  ...
  EditMaintenanceNote(x:any,maintenance: MaintenanceNote) { // Rename the method
    return this._httpClient
      .put(`https://localhost:7251/api/Maintenance/EditMaintenanceNote?Id=${x}`, maintenance) // Update the API URL
      .pipe(map((result) => result));
  }
